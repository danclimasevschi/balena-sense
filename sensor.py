...
def sensor_sgp40(sensor):
    if (temperature is not None) and (humidity is not None):
        ...
        return {
            "raw_gas": sensor.measure_raw(temperature=temperature, relative_humidity=humidity),
            "voc_index": sensor.measure_index(temperature=temperature, relative_humidity=humidity),
        }
    else:
...
def sensor_sht4x(sensor):
    ...
    return {
        "temperature": sensor.temperature,
        "humidity": sensor.relative_humidity,
        "serial_number": hex(sensor.serial_number),
        "mode": adafruit_sht4x.Mode.string[sensor.mode],
    }
...
sensor_dict = {
    0: {
        "name": "PMSA003I Air Quality",
        "short": "PM25",
        "func": sensor_pm25,
        "class_ref": PM25_I2C,
        "arrgh": {"reset_pin": None},
        "i2c_addr": 0x12,
        "chip_id": 0x1C,
        "chip_value": 0x42,
    },
    1: {
        "name": "SCD-30 - NDIR CO2 Temperature and Humidity",
        "short": "SCD30",
        "func": sensor_scd30,
        "class_ref": adafruit_scd30.SCD30,
        "arrgh": {},
        "i2c_addr": 0x61,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    2: {
        "name": "SCD-40 True CO2, Temperature and Humidity",
        "short": "SCD40",
        "func": sensor_scd40,
        "class_ref": adafruit_scd4x.SCD4X,
        "arrgh": {},
        "i2c_addr": 0x62,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    3: {
        "name": "SGP30 TVOC/eCO2 Gas Sensor",
        "short": "SGP30",
        "func": sensor_sgp30,
        "class_ref": adafruit_sgp30.Adafruit_SGP30,
        "arrgh": {},
        "i2c_addr": 0x58,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    4: {
        "name": "VEML6070 UV",
        "short": "VEML6070",
        "func": sensor_veml6070,
        "class_ref": adafruit_veml6070.VEML6070,
        "arrgh": {},
        "i2c_addr": 0x38,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    5: {
        ...
        "short": "VEML7700",
        "func": sensor_veml7700,
        "class_ref": adafruit_veml7700.VEML7700,
        "arrgh": {},
        "i2c_addr": 0x10,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    6: {
        "name": "BME680 - Temperature, Humidity, Pressure and Gas",
        "short": "BME680-0x76",
        "func": sensor_bme680,
        "class_ref": adafruit_bme680.Adafruit_BME680_I2C,
        "arrgh": {"address": 0x76},
        "i2c_addr": 0x76,
        "chip_id": 0xD0,
        "chip_value": 0x61,
    ...
    8: {
        "name": "BME280 Humidity + Barometric Pressure + Temperature",
        "short": "BME280-0x76",
        "func": sensor_bme280,
        "class_ref": adafruit_bme280.Adafruit_BME280_I2C,
        "arrgh": {"address": 0x76},
        "i2c_addr": 0x76,
        "chip_id": 0xD0,
        "chip_value": 0x60,
    ...
    10: {
        ...
        "short": "BMP280-0x76",
        "func": sensor_bmp280,
        "class_ref": adafruit_bmp280.Adafruit_BMP280_I2C,
        "arrgh": {"address": 0x76},
        "i2c_addr": 0x76,
        "chip_id": 0xD0,
        "chip_value": 0x58,
    ...
    12: {
        "name": "MS8607 Pressure, Temperature, and Humidity",
        "short": "MS8607",
        "func": sensor_ms8607,
        "class_ref": MS8607,
        "arrgh": {},
    ...
    13: {
        "name": "HTU21D-F Temperature & Humidity",
        "short": "HTU21D",
        "func": sensor_htu21d,
        "class_ref": HTU21D,
        "arrgh": {},
    ...
    14: {
        ...
        "short": "LTR390",
        "func": sensor_ltr390,
        "class_ref": adafruit_ltr390.LTR390,
        "arrgh": {},
        "i2c_addr": 0x53,
        "chip_id": 0x06,
        "chip_value": 0xB2,
    ...
    15: {
        ...
        "short": "AHT20",
        "func": sensor_aht20,
        "class_ref": adafruit_ahtx0.AHTx0,
        "arrgh": {},
        "i2c_addr": 0x38,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    16: {
        "name": "MPRLS Ported Pressure",
        "short": "MPRLS",
        "func": sensor_mprls,
        "class_ref": adafruit_mprls.MPRLS,
        "arrgh": {"psi_min": 0, "psi_max": 25},
        "i2c_addr": 0x18,
        "chip_id": 0x00,
        "chip_value": 0x00,
    },
    17: {
        "name": "TSL2591 High Dynamic Range Digital Light Sensor",
        "short": "TSL2591",
        "func": sensor_tsl2591,
        "class_ref": adafruit_tsl2591.TSL2591,
        "arrgh": {},
        "i2c_addr": 0x29,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    18: {
        ...
        "short": "SGP40",
        "func": sensor_sgp40,
        "class_ref": adafruit_sgp40.SGP40,
        "arrgh": {},
        "i2c_addr": 0x59,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    19: {
        "name": "ENS160 MOX Gas Sensor",
        "short": "ENS160-0x52",
        "func": sensor_ens160,
        "class_ref": adafruit_ens160.ENS160,
        "arrgh": {"address": 0x52},
        "i2c_addr": 0x52,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    21: {
        "name": "SHT4X Temperature & Humidity Sensor",
        "short": "SHT4X",
        "func": sensor_sht4x,
        "class_ref": adafruit_sht4x.SHT4x,
        "arrgh": {},
        "i2c_addr": 0x44,
        "chip_id": 0x00,
        "chip_value": 0x00,
    ...
    for sensor in sensor_list:
        if sensor is not None:
            ...
            if test_i2c == sensor_info["i2c_addr"]:
                skip_sensor = True
                print(
                    "Skipping sensor {} because the i2c address is already in use by another sensor.".format(
                        sensor_info["short"]
                    )
                )
        j = j + 1
    ...
    if not skip_sensor:
        if sensor_info["chip_id"] != 0x00:
            ...
            if read_chip != sensor_info["chip_value"] and read_chip != -1:
                skip_sensor = True
                print(
                    "Skipping sensor {0} because chip ID {1} does not match {2}.".format(
                        sensor_info["short"], hex(sensor_info["chip_value"]), hex(read_chip)
                    )
                )
